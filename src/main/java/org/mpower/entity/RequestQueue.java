...
public class RequestQueue {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "request_queue_id_seq")
	@SequenceGenerator(name = "request_queue_id_seq", sequenceName = "request_queue_id_seq", allocationSize = 1)
	private int id;
